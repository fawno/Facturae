...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:m="http://www.facturae.gob.es/formato/Versiones/Facturaev3_2_2.xml" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:tns="http://schemas.xmlsoap.org/soap/envelope/">
					...
					function descUnidadMedida(valor)
					{
						...
						switch(valor) {
							...
							case '35':
								...
								break;	
							case '36':
								descripcion = 'Kilovatio por hora-KWh';
								break;	
							default:
								descripcion = valor;
								break;
			...
			<body>					
					...
					<center>						
						<table border="0" width="90%" cellpadding="0" cellspacing="0">				
								...
								<tr  id="factura{$nFactura}">
									<td width="100%">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											...
											<tr>
												<td align="right">
													<a href="#" onclick="mostrarFactura('{$nFactura}')">DETALLE DEL LOTE</a>
												</td>
											</tr>											
										</table>
									</td>
							...
							<tr  id="importesLote" style="display:none">
								<td width="100%">
									<table border="0" cellpadding="0" cellspacing="0" width="100%">
										<tr>
											<td><script>document.write(espacio);</script></td>
										</tr>
										<tr>
											<td>
												<hr/>
													...
													<table border="1" cellpadding="0" cellspacing="0" width="60%">									
														...
														<tr>
															<td width="50%" valign="top" align="right">
																<font class="titulopeque">IMPORTE TOTAL FACTURAS    <script>document.write(espacio);</script></font>
															</td>
														...
														<tr>
															<td width="50%" valign="top" align="right">
																<font class="titulopeque">IMPORTE TOTAL A PAGAR    <script>document.write(espacio);</script></font>
															</td>
															<td width="25%" valign="top">
																<table border="0" cellpadding="0" cellspacing="0" width="100%">
																	<tr>
														...
														<tr>
															<td width="50%" valign="top" align="right">
																<font class="titulopeque">IMPORTE TOTAL A EJECUTAR    <script>document.write(espacio);</script></font>
															</td>
															<td width="25%" valign="top">
																<table border="0" cellpadding="0" cellspacing="0" width="100%">
																	<tr>
														...
														<tr>
															...
															<td valign="top" width="40%">
																<xsl:if test='Parties/SellerParty/LegalEntity/AddressInSpain!=""' >
																	...
																	<xsl:value-of select="Parties/SellerParty/LegalEntity/AddressInSpain/PostCode"/><script>document.write(espacio);</script>   
														...
														<tr>
															...
															<td valign="top" width="40%">
																<xsl:if test='Parties/SellerParty/Individual/AddressInSpain!=""' >
																	...
																	<xsl:value-of select="Parties/SellerParty/Individual/AddressInSpain/PostCode"/><script>document.write(espacio);</script>   
																				...
																				<xsl:choose>
																					<xsl:when test='(AddressInSpain!="") or (OverseasAddress!="")' >
																						<xsl:if test='AddressInSpain!=""' >
																							...
																							<xsl:value-of select="AddressInSpain/PostCode"/><script>document.write(espacio);</script>    
														...
														<tr>
															...
															<td  width="40%">
																<xsl:if test='Parties/BuyerParty/LegalEntity/AddressInSpain!=""' >
																	...
																	<xsl:value-of select="Parties/BuyerParty/LegalEntity/AddressInSpain/PostCode"/><script>document.write(espacio);</script>    
														...
														<tr>
															...
															<td valign="top" width="40%">
																<xsl:if test='Parties/BuyerParty/Individual/AddressInSpain!=""' >
																	...
																	<xsl:value-of select="Parties/BuyerParty/Individual/AddressInSpain/PostCode"/><script>document.write(espacio);</script>    
							...
							<tr  id="listadoFacturas" style="display:none">
								<td width="100%">
									<table border="0" cellpadding="0" cellspacing="0" width="100%">
										<tr>
											<td><script>document.write(espacio);</script></td>
							...
							<tr><td><script>document.write(espacio);</script></td></tr>
							<tr><td><hr/></td></tr>
							<tr><td><script>document.write(espacio);</script></td></tr>
							<tr><td><script>document.write(espacio);</script></td></tr>
							<tr><td><script>document.write(espacio);</script></td></tr>							
	...
	<xsl:template match="//m:Facturae/FileHeader/ThirdParty">		 
		<tr id="tercero" style="display:none">
			 <td width="100%">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						 <td width="100%">
									...
									<tr>
										...
										<td valign="top" width="40%">
											<xsl:if test='LegalEntity/AddressInSpain!=""' >
												...
												<xsl:value-of select="LegalEntity/AddressInSpain/PostCode"/><script>document.write(espacio);</script>    
									...
									<tr>
										...
										<td valign="top" width="40%">
											<xsl:if test='Individual/AddressInSpain!=""' >
												...
												<xsl:value-of select="Individual/AddressInSpain/PostCode"/><script>document.write(espacio);</script>    
					...
					<tr id="datosCesionario" style="display:none">
						<td width="100%">
							<table border="0" cellpadding="0" cellspacing="0" width="100%">							
									...
									<tr>
										...
										<td valign="top" width="40%">
											<xsl:if test='Assignee/LegalEntity/AddressInSpain!=""' >
												...
												<xsl:value-of select="Assignee/LegalEntity/AddressInSpain/PostCode"/><script>document.write(espacio);</script>    
									...
									<tr>
										...
										<td valign="top" width="40%">
											<xsl:if test='Assignee/Individual/AddressInSpain!=""' >
												...
												<xsl:value-of select="Assignee/Individual/AddressInSpain/PostCode"/><script>document.write(espacio);</script>    
																	...
																	<xsl:if test='AccountToBeCredited/BranchInSpainAddress!=""' >
																		<tr>
																			...
																			<td>
																				...
																				<xsl:value-of select="AccountToBeCredited/BranchInSpainAddress/PostCode"/><script>document.write(espacio);</script>    
																	...
																	<xsl:if test='AccountToBeDebited/BranchInSpainAddress!=""' >
																		<tr>
																			...
																			<td>
																				...
																				<xsl:value-of select="AccountToBeDebited/BranchInSpainAddress/PostCode"/><script>document.write(espacio);</script>    
								...
								<xsl:if test='FactoringAssignmentDocument!=""' >
									<tr>
										<td width="100%" colspan="3">
											<font class="titulopeque">
											...
											<table border="1" cellpadding="0" cellspacing="0" width="100%">
												<tr>
													<td width="15%" align="center">
														<font class="titulopeque">NATURALEZA</font>
													</td>
													<td width="20%" align="center">
														<font class="titulopeque">ID. REPRESENTACIÓN</font>
													</td>
													<td width="15%" align="center">
														<font class="titulopeque">TIPO</font>
													</td>
													<td width="10%" align="center">
														<font class="titulopeque">ARCHIVO ELECTRÓNICO</font>
													</td>
													<td width="20%" align="center">
														<font class="titulopeque">URL ARCHIVO ELECTRÓNICO</font>
													</td>
													<td width="20%" align="center">
														<font class="titulopeque">REFERENCIA ELECTRÓNICA</font>
													</td>													
												</tr>
												<xsl:for-each select="FactoringAssignmentDocument">
													<tr>
														<td width="15%" valign="top">
															<xsl:value-of select="DocumentCharacter"/>
														</td>
														<td width="20%" valign="top">
															<xsl:value-of select="RepresentationIdentity"/>								
														</td>
														<td width="15%" valign="top">
														...
														<td width="20%" valign="top">
															<xsl:value-of select="Repository/Reference"/>
														</td>														
													</tr>
												</xsl:for-each>
											</table>
												...
												<td align="center" width="25%">
													...
													<xsl:choose>
														<xsl:when test='InvoiceIssueData/PlaceOfIssue!=""' >
															<xsl:value-of select="InvoiceIssueData/PlaceOfIssue/PostCode"/><script>document.write(espacio);</script><xsl:value-of select="InvoiceIssueData/PlaceOfIssue/PlaceOfIssueDescription"/>
														</xsl:when>
														<xsl:otherwise>
															-
														</xsl:otherwise>
								...
								<tr>
									<td>
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td align="center" width="25%">
													<font class="titulopeque">DESCRIPCIÓN GENERAL</font>
													<br/>
													<xsl:choose>
														<xsl:when test='InvoiceIssueData/InvoiceDescription!=""' >
															<xsl:value-of select="InvoiceIssueData/InvoiceDescription"/>
														</xsl:when>
														<xsl:otherwise>
															-
														</xsl:otherwise>
												...
												<td align="center" valign="top" width="25%">
													<font class="titulopeque">REFERENCIA PEDIDO</font>
													<br/>
													<xsl:choose>
														<xsl:when test='InvoiceIssueData/ReceiverTransactionReference!=""' >
															<xsl:value-of select="InvoiceIssueData/ReceiverTransactionReference"/>
														</xsl:when>
														<xsl:otherwise>
															-
														</xsl:otherwise>
												...
												<td align="center" valign="top" width="25%">
													<font class="titulopeque">EXPEDIENTE CONTRATACIÓN</font>
													<br/>
													<xsl:choose>
														<xsl:when test='InvoiceIssueData/FileReference!=""' >
															<xsl:value-of select="InvoiceIssueData/FileReference"/>
														</xsl:when>
														<xsl:otherwise>
															-
														</xsl:otherwise>
												...
												<td align="center" valign="top" width="25%">
													<font class="titulopeque">REFERENCIA CONTRATO RECEPTOR</font>
													<br/>
													<xsl:choose>
														<xsl:when test='InvoiceIssueData/ReceiverContractReference!=""' >
															<xsl:value-of select="InvoiceIssueData/ReceiverContractReference"/>
														</xsl:when>
														<xsl:otherwise>
															-
														</xsl:otherwise>
						...
						<td width="100%">
							<table border="1" cellpadding="0" cellspacing="0" width="100%">
								...
								<xsl:for-each select="Items/InvoiceLine">
									<tr style="cursor:hand" onclick="mostrarDetalle('{$numFactura}','{position()}_{ItemDescription}')" onMouseOver="this.style.background='#DDEEEE'" onMouseOut="this.style.background='#FFFFFF'">
					...
					<tr>
						<td width="100%">
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td width="100%">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td width="80%" align="right">
													<font class="titulopeque">IMPORTE BRUTO    <script>document.write(espacio);</script></font>
												</td>
												<td width="20%" align="center">
													<table border="1" cellpadding="0" cellspacing="0" width="100%">
														<tr>
								...
								<tr>
									<td width="100%">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td width="80%" align="right">
													<font class="titulopeque">TOTAL DESCUENTOS    <script>document.write(espacio);</script></font>
												</td>
												<td width="20%" align="center">
													<table border="1" cellpadding="0" cellspacing="0" width="100%">
														<tr>
								...
								<tr>
									<td width="100%">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td width="80%" align="right">
													<font class="titulopeque">TOTAL RECARGOS    <script>document.write(espacio);</script></font>
												</td>
												<td width="20%" align="center">
													<table border="1" cellpadding="0" cellspacing="0" width="100%">
														<tr>
								...
								<tr>
									<td width="100%">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td width="80%" align="right">
													<font class="titulopeque">TOTAL IMPORTE BRUTO ANTES IMPUESTOS    <script>document.write(espacio);</script></font>
												</td>
												<td width="20%" align="center">
													<table border="1" cellpadding="0" cellspacing="0" width="100%">
														<tr>
								...
								<tr>
									<td width="100%">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td width="80%" align="right">
													<font class="titulopeque">TOTAL IMPUESTOS REPERCUTIDOS    <script>document.write(espacio);</script></font>
												</td>
												<td width="20%" align="center">
													<table border="1" cellpadding="0" cellspacing="0" width="100%">
														<tr>
								...
								<tr>
									<td width="100%">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td width="80%" align="right">
													<font class="titulopeque">TOTAL IMPUESTOS RETENIDOS    <script>document.write(espacio);</script></font>
												</td>
												<td width="20%" align="center">
													<table border="1" cellpadding="0" cellspacing="0" width="100%">
														<tr>
								...
								<tr>
									<td width="100%">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td width="80%" align="right">
													<font class="titulopeque">TOTAL FACTURA    <script>document.write(espacio);</script></font>
												</td>
												<td width="20%" align="center">
													<table border="1" cellpadding="0" cellspacing="0" width="100%">
														<tr>
								...
								<tr>
									<td width="100%">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td width="80%" align="right">
													<font class="titulopeque">TOTAL ANTICIPOS    <script>document.write(espacio);</script></font>
												</td>
												<td width="20%" align="center">
													<table border="1" cellpadding="0" cellspacing="0" width="100%">
														<tr>
								...
								<tr>
									<td width="100%">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td width="80%" align="right">
													<font class="titulopeque">TOTAL SUPLIDOS    <script>document.write(espacio);</script></font>
												</td>
												<td width="20%" align="center">
													<table border="1" cellpadding="0" cellspacing="0" width="100%">
														<tr>
								...
								<tr>
									<td width="100%">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td width="80%" align="right">
													<font class="titulopeque">TOTAL GASTOS FINANCIEROS    <script>document.write(espacio);</script></font>
												</td>
												<td width="20%" align="center">
													<table border="1" cellpadding="0" cellspacing="0" width="100%">
														<tr>
								...
								<tr>
									<td width="100%">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td width="80%" align="right">
													<font class="titulopeque">TOTAL A PAGAR    <script>document.write(espacio);</script></font>
												</td>
												<td width="20%" align="center">
													<table border="1" cellpadding="0" cellspacing="0" width="100%">
														<tr>
								...
								<xsl:if test='InvoiceTotals/PaymentInKind!=""' >
								<tr>
									<td>									
										<font class="titulopeque"><i>PAGOS EN ESPECIE</i></font>
										<table border="1" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td width="70%" valign="top" align="center">
													<font class="titulopeque">CONCEPTO</font>
											...
											<tr>
												<td width="70%" valign="top">
													<xsl:apply-templates select="InvoiceTotals/PaymentInKind/PaymentInKindReason"/>
												</td>												
												<td width="30%" valign="top" align="right">
													<xsl:value-of select="format-number(InvoiceTotals/PaymentInKind/PaymentInKindAmount,'#.##0,00######')"/>
												</td>
											</tr>
										</table>					
									</td>
								...
								<tr>
									<td width="100%">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td width="80%" align="right">
													<font class="titulopeque">TOTAL A EJECUTAR    <script>document.write(espacio);</script></font>
												</td>
												<td width="20%" align="center">
													<table border="1" cellpadding="0" cellspacing="0" width="100%">
														<tr>
		...
		<tr>
			<td width="100%">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td colspan="2">
							<font class="titulo2">FACTURA RECTIFICADA</font>
						</td>
					</tr>
					<tr>
						<td colspan="2"> </td>
					...
					<tr>
						<xsl:if test='InvoiceNumber!=""'>
							<xsl:choose>
								<xsl:when test='InvoiceSeriesCode!=""' >
									<td width="50%">
										<font class="titulopeque">NÚM. FACT. RECTIFICADA:<script>document.write(espacio);</script></font>
						...
						<xsl:if test='InvoiceSeriesCode!=""'>
							<td width="50%">
								<font class="titulopeque">SERIE FACT. RECTIFICADA:<script>document.write(espacio);</script></font>
					...
					<tr>
						<td width="50%">
							<font class="titulopeque">MOTIVO:<script>document.write(espacio);</script></font>
							   
							<xsl:value-of select="ReasonCode"/> - <xsl:value-of select="ReasonDescription"/>
						</td>
						<td width="50%">
							<font class="titulopeque">CRITERIO RECTIFICACIÓN:<script>document.write(espacio);</script></font>
					...
					<tr>								
						<td colspan="2">
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td width="50%">
										<font class="titulopeque">Fecha inicio:<script>document.write(espacio);</script></font>   
									...
									<td width="50%">
										<font class="titulopeque">Fecha fin:<script>document.write(espacio);</script></font>   
					...
					<tr>
						<xsl:if test='InvoiceIssueDate!=""'>
							<xsl:choose>
								<xsl:when test='AdditionalReasonDescription!=""' >
									<td width="50%">
										<font class="titulopeque">FECHA EXPEDICIÓN:<script>document.write(espacio);</script></font>
									<xsl:value-of select="substring(InvoiceIssueDate,9,2)"/>-<xsl:value-of select="substring(InvoiceIssueDate,6,2)"/>-<xsl:value-of select="substring(InvoiceIssueDate,1,4)"/>
									</td>
								</xsl:when>
								<xsl:otherwise>
									<td width="50%" colspan="2">
						...
						<xsl:if test='AdditionalReasonDescription!=""'>
							<td width="50%">
								<font class="titulopeque">AMPLIACIÓN MOTIVO DE LA RECTIFICACIÓN:<script>document.write(espacio);</script></font>
								<xsl:value-of select="AdditionalReasonDescription"/>
							</td>						
						</xsl:if>
					</tr>
				</table>
		...
		<tr>
			<td width="100%">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						...
						<td align="right">			
							<xsl:if test='RelatedDocuments!=""'>
								<a id="datosAdicLink" href="javascript:mostrarCapa('datosAdic')">Mostrar más datos</a>
							</xsl:if>
						</td>
					</tr>
					<tr>
					...
					<xsl:if test='RelatedDocuments!=""'>
						<tr  id="datosAdic" style="display:none">
							<td colspan="2">									
	...
	<xsl:template match="//m:Facturae/Invoices/Invoice/Items/InvoiceLine">		
		...
		<table width="100%">
		<tr id="{$nFactura}_{position()}_{ItemDescription}" style="display:none">
			<td width="100%">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td align="center" colspan="2">
					...
					<tr>
						<td align="right">
							<a href="#" onclick="mostrarDetalle('{$nFactura}','{position()}_{ItemDescription}')">VOLVER A LA FACTURA</a>
						</td>
					</tr>
					<tr>
						<td colspan="3"> </td>
					...
					<tr>
						<td width="100%">
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td width="80%" align="right">
										<font class="titulopeque">PRECIO UNITARIO SIN IMPUESTOS    <script>document.write(espacio);</script></font>
									</td>
									<td width="20%" align="center">
										<table border="1" cellpadding="0" cellspacing="0" width="100%">
											<tr>
					...
					<tr>
						<td width="100%">
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td width="80%" align="right">
										<font class="titulopeque">COSTE TOTAL    <script>document.write(espacio);</script></font>
									</td>
									<td width="20%" align="center">
										<table border="1" cellpadding="0" cellspacing="0" width="100%">
											<tr>
