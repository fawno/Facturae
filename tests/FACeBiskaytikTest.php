<?php
  ...
  use Fawno\Facturae\Tests\TestCase;
	...
	class FACeBiskaytikTest extends TestCase {
    public function testEnviarFactura () : void {
      ...
      $wsdlFACe = FACe::create(FACeBiskaytik::class, null, [
        'location' => 'https://egoitza.biscaytik.eus/efaktur/ws/puntoEntrada.wsdl',
        'trace' => true,
        //'keep_alive' => true,
      ...
      $this->assertEquals(11, $response->resultado->codigo, print_r($response, true));
    }
